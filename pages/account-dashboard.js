...
import axios from 'axios'         // helps to send HTTP request to your API 
import Web3Modal from 'web3modal' // liabrary to help developers add support for multiple providers in the app
...
export default function AccountDashBoard() {
  ...
  if(loadingState == 'loaded' && !nfts.length) return (<h1
    className='px-20 py-7 text-4x1 text-red-600'>You have not minted any NFTs!!</h1>)

  return ( 
    <div className='p-4'>
        <h1 style={{fontSize:'40px', color:'red'}}>Tokens Minted</h1>
                      ...
                      <div className='p-4 bg-purple-700'>
                        <p style={{height: '64px'}} className='text-3x1 font-semibold'>{
                            ...
                            <div style={{height:'72px', overflow:'hidden'}}>
                              <p className='text-gray-900'>{nft.description}</p>
